...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> FETCHINI_ITEMS_TAB=CREATIVE_MODE_TABS.register("fetchini_items_tab",()-> CreativeModeTab.builder().icon(()->new ItemStack(ModItems.SAPPHIRE.get()))
            ...
            .build());
    public static final RegistryObject<CreativeModeTab> FETCHINI_BLOCKS_TAB=CREATIVE_MODE_TABS.register("fetchini_blocks_tab",()-> CreativeModeTab.builder().icon(()->new ItemStack(ModItems.METAL_DETECTOR.get()))
